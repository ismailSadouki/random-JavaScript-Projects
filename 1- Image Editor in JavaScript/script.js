...
filterOptions.forEach(option => {
    option.addEventListener("click", () => { //adding click event listener to all filters buttons
...
rotateOptions.forEach(option => {
    option.addEventListener("click", () => { // adding click event listener to all filters buttons
        if (option.id === "left") {
            rotate -= 90; // if clicked btn is left rotate, decremont rotate value by -90
        } else if(option.id === "right") {
            rotate += 90; // if clicked btn is right rotate, incremont rotate value by +90
...
const resetFilter = () => {
    // resetting all varb value to the default value
...
const saveImage = () => {
    const canvas = document.createElement("canvas"); // createing canvas element
